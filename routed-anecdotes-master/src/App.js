...
const Anecdote = ({ anecdote }) => {
  return (
    <div>
      <h2>{anecdote.content} by author {anecdote.author}</h2>
...
let CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.addNotification(`${content} created`)
    props.history.push('/')
  }
    ...
    <div class="container">
      <Router>
        <div>
          ...
          <Route path="/create" render={() => <CreateNew addNotification={addNotification} addNew={addNew}/>} />
